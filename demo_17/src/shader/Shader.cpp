...
void Shader::start() { glUseProgram(m_nShaderProgram); }
...
void Shader::setMarix(const std::string& _name, glm::mat4 _matrix) {
    glUniformMatrix4fv(glGetUniformLocation(m_nShaderProgram, _name.c_str()),
