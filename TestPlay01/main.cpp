...
void rend() {
    ...
    GLint n1 = glGetUniformLocation(g_shader.getShaderID(), "iResolution");
    GLint n2 = glGetUniformLocation(g_shader.getShaderID(), "iTime");

    float _time = glfwGetTime();
    glUniform3f(n1, 800.0f, 600.0f, 0.0f);
    glUniform1f(n2, _time);
...
int main() {
    ...
    GLFWwindow* window = glfwCreateWindow(800, 600, "Play", NULL, NULL);
    if (window == NULL) {
